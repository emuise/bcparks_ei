...
bec_bar <- bec_conch_df %>%
  ggplot(aes(x = fct_reorder(zone, perc), y = perc, fill = zone_nm)) +
  geom_bar(stat = "identity") +
  geom_hline(yintercept = 0.17, colour = "#3B4992FF", lty = "dotted", size = 1) +
  geom_hline(yintercept = 0.10, colour = "#EE0000FF", lty = "dotted", size = 1) +
  geom_hline(yintercept = 0.154, colour = "#008B45FF", lty = "dotted", size = 1) +
...
ggsave(here::here("outputs", "bec_map.png"), plot = map, device = "png", height = 7, width = 10)
```
