...
bec_bar <- bec_conch_df %>%
  ...
  geom_col() +
  geom_vline(aes(xintercept = 0.17, colour = "2020 Protection Target (Global)"), lty = "dashed", size = 1) +
  geom_vline(aes(xintercept = 0.25, colour = "2025 Protection Target (Canada)"), lty = "dashed", size = 1) +
  geom_vline(aes(xintercept = 0.154, colour = "2020 BC Proportion Protected"), lty = "dashed", size = 1) +
  theme(legend.position = "bottom") +
