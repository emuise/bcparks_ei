...
Boundaries for all parks and protected areas in British Columbia were obtained from The protected area system in British Columbia is designed to serve as areas available for ecological conservation as well as human recreation [@bcparks2012]. The system consists of a network of PAs and PA complexes (multiple nearby PAs which share the same conservation goals), with large variation in size. Within this network, there are hundreds of parks, taking up 15.4% of the total terrestrial area of British Columbia [947,654km^2^; @environmentalreportingbcProtectedLandsWaters2016]. Both the British Columbian and Canada-wide protected areas mandates commit to conserving ecological integrity across the PA network, using the Canadian definition outlined in Section \@ref(ecological-integrity) [@governmentofcanada2019; @bcparks2012]. Protected areas in the British Columbian network are frequently placed in mountainous, high elevation areas, leading to underrepresentation in high productivity ecosystems [@environmentalreportingbcProtectedLandsWaters2016].

Acquire from <https://cws-scf.ca/CPCAD-BDCAPC_Dec2020.gdb.zip>
