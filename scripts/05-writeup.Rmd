...
The area examined in this study includes all of terrestrial British Columbia. This area was subdivided into BEC zones, and further into BEC subzones for analysis. This allowed for the comparison of PA to unprotected areas (Figure \@ref(fig:study-area)). Parks and Protected Areas in British Columbia were selected for this analysis using similar criteria to @boltonUncoveringRegionalVariability2019. Protected areas were only considered protected in this analysis if they were greater than 100ha in size, and belonged to IUCN categories Ia-IV.
...
### BEC Zones and Subzones

The province of British Columbia, Canada, has an area of 94.4 million hectares, which can be subdivided into sixteen unique ecosystem zones that make up British Columbia's Biogeoclimatic Ecosystem Classification (BEC) system. These classifications are delineated based on climate, climax vegetation species, and soil using similar methods to other ecosystem classification approaches used across the globe [@pojarBiogeoclimaticEcosystemClassification1987]. These BEC zones are further broken down into subzones, variants, and phases based on local microclimate, precipitation, and topography [@meidingerEcosystemsBritishColumbia1991; @pojarBiogeoclimaticEcosystemClassification1987].

Acquired using the **bcmaps** R package.
...
Figure \@ref(fig:vlce-conch) shows...
...
Figure \@ref(fig:lcc-elev) indicates...
